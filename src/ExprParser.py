...
def serializedATN():
    return [
        ...
        16,5,2,0,0,15,14,1,0,0,0,16,19,1,0,0,0,17,15,1,0,0,0,17,18,1,0,0,
        0,18,3,1,0,0,0,19,17,1,0,0,0,20,21,6,2,-1,0,21,22,5,3,0,0,22,26,
        5,1,0,0,23,26,5,3,0,0,24,26,5,1,0,0,25,20,1,0,0,0,25,23,1,0,0,0,
        25,24,1,0,0,0,26,41,1,0,0,0,27,28,10,7,0,0,28,29,5,7,0,0,29,40,3,
        4,2,7,30,31,10,6,0,0,31,32,5,6,0,0,32,40,3,4,2,7,33,34,10,5,0,0,
        34,35,5,5,0,0,35,40,3,4,2,6,36,37,10,4,0,0,37,38,5,4,0,0,38,40,3,
...
class ExprParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "COMMENT", "NEWLINE", "NUM", "MES", "MINUS", 
                      "MULT", "POT" ]
    ...
    def root(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==ExprParser.COMMENT or _la==ExprParser.NUM):
                    break
